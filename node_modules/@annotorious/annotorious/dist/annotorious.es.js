...
var Mo = (e, t, n) => t in e ? ko(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n;
...
function No(e, t, { bubbles: n = !1, cancelable: o = !1 } = {}) {
...
function _e(e, t, n, o, s, i, l = null, r = [-1]) {
  ...
  }) : [], f.update(), d = !0, Se(f.before_update), f.fragment = o ? o(f.ctx) : !1, t.target) {
    if (t.hydrate) {
      const u = Oo(t.target);
...
var Vo = ro.exports;
const Xo = /* @__PURE__ */ Uo(Vo), xt = {}, Je = (e, t) => xt[e] = t, Zt = (e) => xt[e.type].area(e), Ho = (e, t, n, o) => xt[e.type].intersects(e, t, n, o), ue = (e) => {
...
const Ko = {
  ...
  const n = lo(e.geometry.points, t), o = ue(n);
  return {
    ...e,
    geometry: {
      ...e.geometry,
  ...
  for (let o = 0; o < e.points.length - 1; o++) {
    ...
    if (s.type === "CURVE" || i.type === "CURVE") {
      ...
      for (let a = 0; a < r.length - 1; a++)
        if (ln(t, r[a], r[a + 1]) <= n) return !0;
    } else if (ln(t, s.point, i.point) <= n) return !0;
  }
  return !1;
}, ln = (e, t, n) => {
...
const St = (e) => bt(e.target), bt = (e) => {
...
}, Qo = (e) => (e == null ? void 0 : e.type) === "FragmentSelector" ? !0 : typeof e == "string" ? e.indexOf("#") < 0 ? !1 : /#xywh(?:=(?:pixel:|percent:)?)(.+?),(.+?),(.+?),(.+)$/i.test(e) : !1, xo = (e, t = !1) => {
  const n = typeof e == "string" ? e : e.value, o = /(xywh)=(?:(pixel|percent):)?:?(.+?),(.+?),(.+?),(.+)*/g, s = [...n.matchAll(o)][0];
  if (!s) throw new Error("Not a MediaFragment: " + n);
  const [i, l, r, a, f, d, u] = s;
  if (l !== "xywh") throw new Error("Unsupported MediaFragment: " + n);
  if (r && r !== "pixel") throw new Error(`Unsupported MediaFragment unit: ${r}`);
...
}, fo = "http://www.w3.org/2000/svg", an = (e) => {
  const t = (o) => {
  ...
  const o = new XMLSerializer().serializeToString(e.documentElement).replace("<svg>", `<svg xmlns="${fo}">`);
  return new DOMParser().parseFromString(o, "image/svg+xml").documentElement;
}, st = (e) => {
  const n = new DOMParser().parseFromString(e, "image/svg+xml"), o = n.lookupPrefix(fo), s = n.lookupNamespaceURI(null);
  return o || s ? an(n).firstChild : an(es(n)).firstChild;
}, ts = (e) => {
  const t = uo(e), n = [];
  let o = [], s = [0, 0];
  for (const i of t)
  ...
  const t = st(e), n = parseFloat(t.getAttribute("cx")), o = parseFloat(t.getAttribute("cy")), s = parseFloat(t.getAttribute("rx")), i = parseFloat(t.getAttribute("ry")), l = {
    minX: n - s,
    minY: o - i,
    maxX: n + s,
    maxY: o + i
  ...
  const t = st(e), n = parseFloat(t.getAttribute("x1")), o = parseFloat(t.getAttribute("x2")), s = parseFloat(t.getAttribute("y1")), i = parseFloat(t.getAttribute("y2")), l = {
    minX: Math.min(n, o),
    minY: Math.min(s, i),
    maxX: Math.max(n, o),
    maxY: Math.max(s, i)
  ...
  const t = st(e), n = t.nodeName === "path" ? t : Array.from(t.querySelectorAll("path"))[0], o = n == null ? void 0 : n.getAttribute("d");
  if (!o)
  ...
  const t = st(e), n = t.nodeName === "rect" ? t : Array.from(t.querySelectorAll("rect"))[0];
  if (!n) throw new Error("Could not parse SVG rect");
  ...
  const t = st(e), s = (t.nodeName === "path" ? [t] : Array.from(t.querySelectorAll("path"))).map((a) => a.getAttribute("d") || "").map((a) => ts(a)).filter(Boolean), i = s.reduce((a, f) => [...a, ...f.rings[0].points], []), l = ue(i);
...
}, us = (e) => `<g>${e.polygons.map((n) => `<path fill-rule="evenodd" d="${Le(n)}" />`).join("")}</g>`, ds = (e) => {
  let t;
  switch (e.type) {
    case x.RECTANGLE: {
    ...
    case x.POLYLINE:
      t = `<svg><path d="${co(e.geometry)}" /></svg>`;
  }
  if (t)
...
function Be(e, t) {
  ...
  if (e && t && (n = e.constructor) === t.constructor) {
    ...
    if (!n || typeof e == "object") {
      o = 0;
      for (n in e)
        if (cn.call(e, n) && ++o && !cn.call(t, n) || !(n in t) || !Be(e[n], t[n])) return !1;
      return Object.keys(t).length === o;
    }
  }
  return e !== e && t !== t;
}
const _s = Symbol("clean");
let Me = [], De = 0;
const ht = 4, ys = globalThis.nanostoresGlobal || (globalThis.nanostoresGlobal = { epoch: 0 }), $t = /* @__NO_SIDE_EFFECTS__ */ (e) => {
  ...
  return process.env.NODE_ENV !== "production" && (n[_s] = () => {
    t = [], n.lc = 0, n.off();
  }), n;
}, ws = (e) => {
...
const Dt = { selected: [] }, bs = (e, t, n) => {
  ...
  const i = () => {
    ...
    const S = y.reduce((w, A) => {
      const _ = h(A);
      return _ === "EDIT" ? [...w, { id: A.id, editable: !0 }] : _ === "SELECT" ? [...w, { id: A.id }] : w;
    }, []);
...
const Bs = 250, Rs = (e, t) => {
  ...
  const a = (p) => p && p.length > 0 && e.bulkDeleteAnnotations(p), f = (p) => p && p.length > 0 && e.bulkAddAnnotations(p, !1), d = (p) => p && p.length > 0 && e.bulkUpdateAnnotations(p.map(({ oldValue: y }) => y)), u = (p) => p && p.length > 0 && e.bulkUpdateAnnotations(p.map(({ newValue: y }) => y)), h = (p) => p && p.length > 0 && e.bulkAddAnnotations(p, !1), g = (p) => p && p.length > 0 && e.bulkDeleteAnnotations(p);
  return {
  ...
  return t.on("undo", S(!0)), t.on("redo", S(!1)), { on: h, off: g, emit: p };
}, Vs = (e) => (t) => t.reduce((n, o) => {
  ...
  }, u = (w, A = !0) => fetch(w).then((_) => _.json()).then((_) => (g(_, A), _)), h = (w) => {
    if (typeof w == "string") {
      const A = o.getAnnotation(w);
...
}, Jr = (e, t, n) => typeof t == "function" ? t(e, n) : t, Qr = (e, t) => typeof e != "function" && typeof t != "function" ? {
  ...e || {},
  ...t || {}
} : (n, o) => {
...
const qs = () => ({ isGuest: !0, id: Fs("1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_", 20)() }), Ks = (e) => {
  ...
  return `${n}`;
}, _o = (e) => e ? typeof e == "object" ? { ...e } : e : void 0, Ws = (e, t) => (Array.isArray(e) ? e : [e]).map((n) => {
...
zs();
const $r = (e, t = { strict: !0, invertY: !1 }) => ({ parse: (s) => Qs(s, t), serialize: (s) => xs(s, e, t) }), Qs = (e, t = { strict: !0, invertY: !1 }) => {
  const n = e.id || ho(), {
    creator: o,
    created: s,
    modified: i,
    body: l,
    ...r
  } = e, a = Ws(l || [], n), f = Array.isArray(e.target) ? e.target[0] : e.target, d = typeof f == "string" ? f : Array.isArray(f.selector) ? f.selector[0] : f.selector, u = Qo(d) ? xo(d, t.invertY) : (d == null ? void 0 : d.type) === "SvgSelector" ? fs(d) : void 0, h = Array.isArray(r.target) ? r.target[0] : r.targret;
  return u || !t.strict ? {
    parsed: {
      ...r,
      id: n,
  ...
  let f;
  try {
    o.type === x.RECTANGLE && !o.geometry.rot ? f = $o(o.geometry) : f = ds(o);
  } catch (u) {
    if (n.strict)
      throw u;
    f = o;
...
}, Pe = typeof window > "u" || typeof navigator > "u" ? !1 : "ontouchstart" in window || navigator.maxTouchPoints > 0 || // @ts-ignore
...
function ai(e, t, n) {
  let o, { x: s } = t, { y: i } = t, { scale: l } = t, { selected: r = void 0 } = t, a = !1;
  const f = (_) => {
  ...
  return {
    ...
    m(v, E) {
      ...
      for (let m = 0; m < N.length; m += 1)
        N[m] && N[m].m(v, E);
      R(v, w, E), j && j.m(v, E), R(v, A, E), _ = !0, k || (L = [
        Q(
          u,
          "pointerup",
          /*onShapePointerUp*/
    ...
    d(v) {
      v && (B(t), B(d), B(u), B(g), B(p), B(S), B(w), B(A)), I && I.d(), T && T.d(), He(N, v), j && j.d(v), k = !1, Se(L);
    }
  };
}
function gi(e) {
...
function yi(e, t, n) {
  let o, s, i;
  const l = Ye();
  let { shape: r } = t, { computedStyle: a } = t, { transform: f } = t, { viewportScale: d = 1 } = t, { svgEl: u } = t, h, g = !1, p, y = [];
  const S = () => n(7, g = !0), w = () => n(7, g = !1), A = (m) => {
    ...
    n(7, g = !0), m.preventDefault(), m.stopPropagation(), p = performance.now();
  }, I = (m) => (b) => {
...
function Si(e) {
  ...
  return I = new Ve({
    ...
    m(z, D) {
      R(z, t, D), G(t, n), G(n, o), G(n, a), R(z, d, D), R(z, u, D), G(u, h), G(u, w), re(I, u, null), R(z, T, D), R(z, Y, D), G(Y, N), G(Y, j), R(z, E, D), R(z, m, D), R(z, F, D), R(z, V, D), R(z, he, D), R(z, ne, D), R(z, ge, D), R(z, ie, D), R(z, Mt, D), re(Ce, z, D), R(z, Tt, D), re(Ie, z, D), R(z, Lt, D), re(Oe, z, D), R(z, Pt, D), re(Ne, z, D), W = !0, Ct || (nn = [
    ...
    i(z) {
      W || (U(I.$$.fragment, z), U(Ce.$$.fragment, z), U(Ie.$$.fragment, z), U(Oe.$$.fragment, z), U(Ne.$$.fragment, z), W = !0);
    },
    o(z) {
      H(I.$$.fragment, z), H(Ce.$$.fragment, z), H(Ie.$$.fragment, z), H(Oe.$$.fragment, z), H(Ne.$$.fragment, z), W = !1;
    },
    d(z) {
      z && (B(t), B(d), B(u), B(T), B(Y), B(E), B(m), B(F), B(V), B(he), B(ne), B(ge), B(ie), B(Mt), B(Tt), B(Lt), B(Pt)), le(I), le(Ce, z), le(Ie, z), le(Oe, z), le(Ne, z), Ct = !1, Se(nn);
    }
  };
}
function ki(e) {
...
function Mi(e, t, n) {
  let o, s, i, l, r, { shape: a } = t, { computedStyle: f } = t, { transform: d } = t, { viewportScale: u = 1 } = t, { svgEl: h } = t, g = !1;
  const p = (_, k, L) => {
...
function Qt(e, t) {
  ...
  if (e && t && (n = e.constructor) === t.constructor) {
    ...
    if (!n || typeof e == "object") {
      o = 0;
      for (n in e)
        if (Sn.call(e, n) && ++o && !Sn.call(t, n) || !(n in t) || !Qt(e[n], t[n])) return !1;
      return Object.keys(t).length === o;
    }
  }
  return e !== e && t !== t;
...
function On(e) {
  ...
  return {
    ...
    d(T) {
      T && B(t), A && A.d(), _ && _.d(), He(L, T), S = !1, Se(w);
    }
  };
}
function Nn(e) {
...
function Di(e, t, n) {
  ...
  const S = () => n(7, g = !0), w = () => n(7, g = !1), A = (b) => {
    ...
    n(7, g = !0), b.preventDefault(), b.stopPropagation(), p = performance.now();
  }, I = (b, P, M) => (O) => {
...
function Ui(e, t, n) {
  ...
  return Re(() => (n(6, u = new l({
    ...
    5 && n(7, o = Ge(i, r, { selected: !0, hovered: !0 })), e.$$.dirty & /*annotation, editorComponent*/
...
function ji(e, t, n) {
  ...
  Re(() => {
    i("pointerdown", S), i("pointermove", w), i("pointerup", A, !0);
  });
...
function Wi(e, t, n) {
  let o, s, i;
  const l = Ye();
  let { addEventListener: r } = t, { drawingMode: a } = t, { transform: f } = t, { viewportScale: d = 1 } = t, u, h = [], g, p, y = !1;
  const S = (I) => {
  ...
  Re(() => {
    r("pointerdown", S, !0), r("pointermove", w), r("pointerup", A, !0), r("dblclick", _, !0);
  });
  ...
  return {
    ...
    m(u, h) {
      ...
      for (let g = 0; g < a.length; g += 1)
        a[g] && a[g].m(n, null);
      G(t, o), d && d.m(o, null), e[35](o), e[36](t), s = !0, i || (l = [
    ...
    d(u) {
      u && B(t), He(a, u), d && d.d(), e[35](null), e[36](null), i = !1, Se(l);
    }
  };
}
function Pr(e, t, n) {
  ...
  e.$$.on_destroy.push(() => y());
  let { drawingEnabled: w } = t, { image: A } = t, { preferredDrawingMode: _ } = t, { state: k } = t, { style: L = void 0 } = t, { toolName: I = Eo()[0] } = t, { user: T } = t, { visible: Y = !0 } = t, N = 0;
...
class Or {
  ...
  remove(t, n) {
    ...
    let r, a, f;
    for (; o || i.length; ) {
      if (o || (o = i.pop(), a = i[i.length - 1], r = l.pop(), f = !0), o.leaf) {
        const d = Nr(t, o.children, n);
        if (d !== -1)
          return o.children.splice(d, 1), i.push(o), this._condense(i), this;
      }
      !f && !o.leaf && zt(o, s) ? (i.push(o), l.push(r), r = 0, a = o, o = o.children[0]) : a ? (r++, o = a.children[r], f = !1) : o = null;
    }
    return this;
  }
  toBBox(t) {
  ...
  _build(t, n, o, s) {
    ...
    s || (s = Math.ceil(Math.log(i) / Math.log(l)), l = Math.ceil(i / Math.pow(l, s - 1))), r = Ke([]), r.leaf = !1, r.height = s;
  ...
  _splitRoot(t, n) {
    this.data = Ke([t, n]), this.data.height = t.height + 1, this.data.leaf = !1, ze(this.data, this.toBBox);
  }
...
const Ur = () => {
  ...
  return t.observe(({ changes: a }) => {
    n.set((a.created || []).map((f) => f.target), !1), (a.deleted || []).forEach((f) => n.remove(f.target)), (a.updated || []).forEach(({ oldValue: f, newValue: d }) => n.update(f.target, d.target));
  }), {
    store: {
      ...t,
      getAt: (a, f, d, u) => {
  ...
  if (e.nodeName === "CANVAS")
    ...
    const s = e;
    t = document.createElement("canvas"), t.width = s.width, t.height = s.height, n = t.getContext("2d", { willReadFrequently: !0 }), n.drawImage(s, 0, 0, s.width, s.height);
  }
  let o = 0;
  for (let s = 1; s < 10; s++)
    for (let i = 1; i < 10; i++) {
...
}), Jn = typeof navigator > "u" ? !1 : navigator.userAgent.indexOf("Mac OS X") !== -1, zr = (e, t) => {
...
export {
  ...
  Vi as EditorMount,
  Ve as Handle,
  el as IdentityTransform,
  yo as MidpointHandle,
  wi as PolygonEditor,
  Ti as RectangleEditor,
  Jo as RectangleUtil,
  Fi as RubberbandRectangle,
  Cr as SVGAnnotationLayer,
  x as ShapeType,
  Hi as ToolMount,
  go as UserSelectAction,
  $r as W3CImageFormat,
  wr as addEventListeners,
  Jt as approximateAsPolygon,
  wt as boundsFromMultiPolygonElements,
  ue as boundsFromPoints,
  Qr as chainStyles,
  Zt as computeArea,
  vt as computePolygonArea,
  co as computeSVGPath,
  Jr as computeStyle,
  Zr as createBody,
  tl as createImageAnnotator,
  Xr as createImageAnnotatorState,
  _r as createSVGTransform,
  Hr as createSvelteImageAnnotatorState,
  xr as defaultColorProvider,
  jr as detectTheme,
  yt as distance,
  ti as enableResponsive,
  Fr as fillDefaults,
  qo as getAllCorners,
  Ri as getEditor,
  ...
  Ao as getSVGPoint,
  vo as getTool,
  zr as initKeyboardCommands,
  Ho as intersects,
  Qo as isFragmentSelector,
  St as isImageAnnotation,
  bt as isImageAnnotationTarget,
  Jn as isMac,
  At as isPointInPolygon,
  Pe as isTouch,
  Eo as listDrawingTools,
  Le as multipolygonElementToPath,
  xo as parseFragmentSelector,
  fs as parseSVGSelector,
  Qs as parseW3CImageAnnotation,
  Go as pointsToPath,
  Yi as registerEditor,
  Je as registerShapeUtil,
  Ji as registerTool,
  Gr as sampleBrightness,
  $o as serializeFragmentSelector,
  ds as serializeSVGSelector,
  xs as serializeW3CImageAnnotation,
  Zn as setTheme,
  Kr as simplifyMultiPolygon,
  lo as simplifyPoints,
  Wr as simplifyPolygon,
  Vr as toSvelteStore
};
